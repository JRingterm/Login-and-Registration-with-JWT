"""
Django settings for login_with_jwt project.
...
SECRET_KEY = 'django-insecure-l#abv7w*t%!v=x@i(kkjnpod*zr#hbx+@r+ipplyw8o&)f64f&'
...
#user를 이용할 때 더 이상 username이 아닌 email을 사용하여 로그인 및 계정 생성을 진행할 수 있게 된다. (users에서 그렇게 설정해서.)
...
ROOT_URLCONF = 'login_with_jwt.urls'
...
WSGI_APPLICATION = 'login_with_jwt.wsgi.application'
